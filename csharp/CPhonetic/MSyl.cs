...
namespace CPhonetic.Mandarin
{
	...
	{
		static public INITGROUP GetGroup(this INIT init){return (INITGROUP)(((byte)init + 5)/6);}
	...
	public struct MSyl : IEquatable<MSyl>
	{
		...
		internal MSyl(ushort code){_initTone = _rime = 0 ; _code = code;}
		...
		static public bool operator !=(MSyl lhs, MSyl rhs){return !(lhs == rhs);}
		...
		public string ToString(IMTransliterator trans)
		{
